    ...
    <motion.div
      ...
      <motion.div
        ...
        <motion.div
          ...
          that are regarded as very different but have always been closely
          linked with each other, and, their interdependency is clearly obvious.
          Technology has allowed designers to create innovative products and
          solutions that were previously deemed to be impossible, while the
          design has played a vital role in making technology accessible. This
          first annual DES-TECH event is titled ELYSIAN'23, that refers to
          "Something that is grand, heavenly, blissful a paradise or pure" . It
          comes from the Greek word 'Elysium', a place in Greek mythology that
